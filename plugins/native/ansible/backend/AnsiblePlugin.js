...
exports.createAnsiblePlugin = createAnsiblePlugin;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 7: return [4 /*yield*/, Promise.resolve().then(function () { return require("fs"); })];
                    case 8:
                        fs = _a.sent();
 ...
 */
function createAnsiblePlugin(config, logger, performanceMonitor) {
