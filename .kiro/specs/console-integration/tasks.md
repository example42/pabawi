...
- [x] 1. Core types, configuration, and database schema
  - [x] 1.1 Define ConsolePlugin interface and related types
  ...
  - [x] 1.2 Add console configuration to ConfigService and schema
  ...
  - [x] 1.3 Write property test for configuration parsing (Property 14)
  ...
  - [x] 1.4 Create database migration 018_console_sessions.sql
  ...
  - [x] 1.5 Create database migration 019_console_permissions.sql
...
- [x] 3. ConsoleSessionManager service
  - [x] 3.1 Implement ConsoleSessionManager
  ...
  - [x] 3.2 Write property test for session token validation (Property 2)
  ...
  - [x] 3.3 Write property test for concurrent session limit (Property 7)
  ...
  - [x] 3.4 Write property test for session record completeness (Property 8)
  ...
  - [x] 3.5 Write property test for audit log completeness (Property 9)
...
- [x] 5. IntegrationManager extension and console availability
  - [x] 5.1 Extend IntegrationManager with console provider support
  ...
  - [x] 5.2 Write property test for availability response ordering (Property 10)
  ...
  - [x] 5.3 Write property test for unsupported node empty response (Property 11)
  ...
  - [x] 5.4 Write property test for unhealthy provider exclusion (Property 15)
...
- [x] 6. WebSocket proxy server
  - [x] 6.1 Implement ConsoleWebSocketProxy
  ...
  - [x] 6.2 Write property test for binary frame relay integrity (Property 3)
  ...
  - [x] 6.3 Write property test for terminal resize validation (Property 4)
...
- [x] 8. ProxmoxConsoleProvider
  - [x] 8.1 Implement ProxmoxConsoleProvider
  ...
  - [x] 8.2 Write property test for guest type routing (Property 12)
  ...
  - [x] 8.3 Write property test for non-running guest rejection (Property 13)
  ...
  - [x] 8.4 Write property test for provider registration (Property 1)
...
- [x] 9. Console REST routes
  - [x] 9.1 Implement console route factory and endpoints
  ...
  - [x] 9.2 Write property test for RBAC session creation (Property 5)
  ...
  - [x] 9.3 Write property test for RBAC cross-user termination (Property 6)
...
- [x] 10. Wire backend components together
  - [x] 10.1 Register ProxmoxConsoleProvider and wire routes in server.ts
...
- [x] 12. Frontend ConsoleViewer component
  - [x] 12.1 Implement ConsoleViewer Svelte 5 component
  ...
  - [x] 12.2 Implement console availability UI on node detail page
