...
- [x] 6. Journal Service — Data Model and Core Logic
  - [x] 6.1 Create journal_entries migration and Zod schemas
  ...
  - [x] 6.2 Implement JournalService core (recordEvent, addNote, getNodeTimeline)
  ...
  - [x] 6.3 Implement JournalService aggregateTimeline with live source merging
...
- [x] 7. Integration Config Service — Storage, Encryption, and Merge
  - [x] 7.1 Create integration_configs migration and types
  ...
  - [x] 7.2 Implement IntegrationConfigService with encryption
  ...
  - [x] 7.3 Implement getEffectiveConfig and rotateEncryptionKey
...
- [ ] 9. AWS Plugin — Core Implementation
  ...
  - [x] 9.2 Implement AWS EC2 inventory and resource discovery
  ...
  - [x] 9.3 Implement AWS EC2 provisioning and lifecycle actions
  ...
  - [x] 9.4 Implement AWS health check
...
- [x] 11. Checkpoint - Plugins complete
  - Ensure all tests pass, ask the user if questions arise.
...
- [x] 12. Backend API Routes — Journal, Config, and AWS
  - [x] 12.1 Create Journal API routes
  ...
  - [x] 12.2 Create Integration Config API routes
  ...
  - [x] 12.3 Create AWS integration API routes
...
- [ ] 15. Frontend — AWS Provisioning and Integration Config UI
  ...
  - [x] 15.2 Create Integration Config management pages
