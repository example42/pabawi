        ...
        {:else if keyNodeData}
          ...
          {#if viewMode === 'grouped'}
            ...
            <div class="space-y-4">
              ...
              {:else}
                {#each keyNodeData.groupedByValue as group, index (group.valueString)}
                  <div class="rounded-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="p-3">
                      <div class="flex flex-wrap gap-2">
                        {#each group.nodes as nodeId (nodeId)}
                          <button
                            type="button"
              ...
              {#if keyNodeData.nodes.filter(n => !n.found).length > 0}
                <div class="rounded-lg border border-gray-200 dark:border-gray-700">
                  ...
                  <div class="p-3">
                    <div class="flex flex-wrap gap-2">
                      {#each keyNodeData.nodes.filter(n => !n.found) as node (node.nodeId)}
                        <button
                          type="button"
