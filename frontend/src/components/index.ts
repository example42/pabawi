...
export { default as CheckmkSetupGuide } from "./CheckmkSetupGuide.svelte";
...
export { default as ManageTab } from "./ManageTab.svelte";
export { default as MonitorTab } from "./MonitorTab.svelte";
