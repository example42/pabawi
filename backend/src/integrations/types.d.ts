 ...
 */
export type CapabilityCategory = "command" | "task" | "info" | "config" | "inventory" | "package" | "file" | "service" | "user" | "audit" | "secret" | "custom";
 ...
 */
export type WidgetSlot = "dashboard" | "node-detail" | "inventory-panel" | "standalone-page" | "sidebar" | "modal";
/**
 ...
 */
export type PluginRouteHandler = (req: Record<string, unknown>, res: Record<string, unknown>, next: (error?: unknown) => void) => void | Promise<void>;
/**
