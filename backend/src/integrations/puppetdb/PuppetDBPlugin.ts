...
export class PuppetDBPlugin implements BasePluginInterface {
  ...
  readonly widgets: PluginWidget[] = [
    ...
    {
      id: "puppetdb:pql-query-builder",
      name: "PQL Query Builder",
      component: "./components/PQLQueryBuilder.svelte",
      slots: ["standalone-page", "modal"],
      size: "full",
      requiredCapabilities: ["puppetdb.query"],
      icon: "search",
      priority: 80,
      config: {
        showExamples: true,
    ...
    {
      id: "puppetdb:events-timeline",
      name: "Events Timeline",
      component: "./components/EventsTimeline.svelte",
