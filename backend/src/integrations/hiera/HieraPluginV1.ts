 ...
 *
 * @module integrations/hiera/HieraPluginV1
 * @version 1.0.0
 */
...
import type { HieraService } from "./HieraService";
...
export const HieraPluginConfigSchema = z.object({
  ...
  catalogCompilation: z.object({
    enabled: z.boolean().optional().default(false),
    timeout: z.number().optional().default(30000),
    cacheTTL: z.number().optional().default(600000),
  }).optional().default({ enabled: false, timeout: 30000, cacheTTL: 600000 }),
  codeAnalysis: z.object({
    enabled: z.boolean().optional().default(true),
    lintEnabled: z.boolean().optional().default(true),
    moduleUpdateCheck: z.boolean().optional().default(true),
    analysisInterval: z.number().optional().default(3600000),
    exclusionPatterns: z.array(z.string()).optional(),
  }).optional().default({ enabled: true, lintEnabled: true, moduleUpdateCheck: true, analysisInterval: 3600000 }),
});
 ...
 */
export class HieraPluginV1 implements BasePluginInterface {
  // =========================================================================
  // Plugin Metadata
  // =========================================================================
  ...
  readonly widgets: PluginWidget[] = [
    {
      id: "hiera:explorer",
      name: "Hiera Explorer",
      component: "./components/HieraExplorer.svelte",
    ...
    },
    {
      id: "hiera:key-lookup",
      name: "Key Lookup",
      component: "./components/KeyLookup.svelte",
    ...
    },
    {
      ...
      component: "./components/HierarchyViewer.svelte",
    ...
    },
    {
      ...
      component: "./components/NodeHieraData.svelte",
      slots: ["node-detail"],
      size: "large",
    ...
    },
    {
      ...
      name: "Code Analysis",
      component: "./components/CodeAnalysis.svelte",
      slots: ["dashboard", "standalone-page"],
      size: "large",
    ...
    },
    {
      ...
      component: "./components/KeyValuesGrid.svelte",
  ...
  /**
   * Set the IntegrationManager for accessing other plugins (e.g., PuppetDB for facts)
   */
   ...
   */
  setHieraService(service: HieraService): void {
   ...
   */
  setCodeAnalyzer(analyzer: CodeAnalyzer): void {
    ...
    return [
      // Hiera Key Lookup
      {
        ...
        schema: {
          arguments: {
            node: {
              type: "string",
              description: "Node certname to resolve key for",
              required: true,
            },
            key: {
              type: "string",
              description: "Hiera key to lookup",
              required: true,
            },
            environment: {
              type: "string",
              description: "Puppet environment (default: production)",
              required: false,
              default: "production",
            },
            lookupMethod: {
              type: "string",
              description: "Merge strategy: first, unique, hash, deep",
              required: false,
              default: "first",
              choices: ["first", "unique", "hash", "deep"],
            },
          },
          returns: {
            type: "HieraResolution",
            description: "Resolution result with value, source file, and hierarchy level",
          },
        },
      },
      ...
      // List/Search Keys
      {
        ...
        schema: {
          ...
          returns: {
            type: "HieraKeyIndex",
            description: "Index of matching Hiera keys",
          },
        },
      },
      ...
      // Get Key Details
      {
        ...
        schema: {
          ...
          returns: {
            type: "HieraKey",
            description: "Key details including all locations and values",
          },
        },
      },
      ...
      // Hierarchy Information
      {
        ...
        schema: {
          arguments: {
            node: {
              type: "string",
              description: "Node to resolve hierarchy paths for (optional)",
              required: false,
            },
            environment: {
              type: "string",
          ...
          returns: {
            type: "HierarchyInfo",
            description: "Hierarchy configuration and resolved file paths",
          },
        },
      },
      ...
      // Scan Hieradata
      {
        ...
        schema: {
          arguments: {
            refresh: {
              type: "boolean",
              description: "Force rescan even if cache is valid",
              required: false,
              default: false,
            },
          },
          returns: {
            type: "HieraKeyIndex",
            description: "Complete key index from scan",
          },
        },
      },
      ...
      // Node Hiera Data
      {
        ...
        schema: {
          ...
          returns: {
            type: "NodeHieraData",
            description: "All Hiera data for the node including used/unused keys",
          },
        },
      },
      ...
      // Key Values Across Nodes
      {
        ...
        schema: {
          arguments: {
            key: {
              type: "string",
              description: "Hiera key to lookup across nodes",
              required: true,
            },
          },
          returns: {
            type: "KeyNodeValues[]",
            description: "Array of values per node",
          },
        },
      },
      ...
      // Code Analysis
      {
        ...
        schema: {
          arguments: {
            ...
            includeLint: {
              type: "boolean",
              description: "Include lint issues in results",
              required: false,
              default: true,
            },
            includeModuleUpdates: {
              type: "boolean",
              description: "Check for module updates",
              required: false,
              default: true,
            },
          },
          returns: {
            ...
            description: "Analysis results including unused code, lint issues, and module updates",
          },
        },
      },
    ];
  ...
  async initialize(): Promise<void> {
    ...
    try {
      this.logger.info("Initializing HieraPluginV1", {
        component: "HieraPluginV1",
      ...
      this.logger.info("HieraPluginV1 initialized successfully", {
        component: "HieraPluginV1",
        operation: "initialize",
        metadata: {
      ...
      this.logger.error("HieraPluginV1 initialization failed", {
        component: "HieraPluginV1",
        operation: "initialize",
        metadata: {
  ...
  async shutdown(): Promise<void> {
    this.logger.info("HieraPluginV1 shutting down", {
      component: "HieraPluginV1",
      operation: "shutdown",
    });
  ...
  private async getHierarchy(
    ...
    hierarchy: unknown;
    resolvedPaths?: HierarchyFileInfo[];
  }> {
   ...
   */
  getHieraService(): HieraService | null {
   ...
   */
  getCodeAnalyzer(): CodeAnalyzer | null {
    return this.codeAnalyzer;
  }

  /**
   * Get the IntegrationManager instance
   * Used for accessing other integrations like PuppetDB
   */
...
/**
 * Factory function for creating HieraPluginV1 instances
 */
