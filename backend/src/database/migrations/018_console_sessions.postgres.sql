-- Migration 018 (PostgreSQL): Console sessions
...
-- Requirements: 2.7
--
-- Identical to the shared SQLite file except for the created_at default:
-- datetime('now') is a SQLite function and does not exist in PostgreSQL.
