...
import { ExecutionRepository, ExecutionRecord, ExecutionType, ExecutionStatus } from '../../src/database/ExecutionRepository';
...
describe('ExecutionRepository', () => {
  ...
  describe('constructor', () => {
    it('should throw error if database is not provided', () => {
      expect(() => new ExecutionRepository(null as any)).toThrow('Database connection is required');
    });
  });
  ...
  describe('update', () => {
    ...
    it('should update execution results', async () => {
      ...
      await repository.update(id, { results, status: 'success' as ExecutionStatus });
