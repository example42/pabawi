...
if [[ "$SKIP_ENV" != "true" ]]; then
  ...
  PABAWI_BOOTSTRAP_TOKEN=$(openssl rand -hex 32)
...
PABAWI_BOOTSTRAP_TOKEN=${PABAWI_BOOTSTRAP_TOKEN}
...
EOF
  ...
  info "Read PABAWI_BOOTSTRAP_TOKEN from backend/.env and enter it in the initial setup form."
fi
