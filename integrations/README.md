...
```bash
# Bolt
BOLT_PROJECT_PATH=./integrations/bolt

# Ansible
ANSIBLE_CONFIG=./integrations/ansible/ansible.cfg

# Puppet (control repo / r10k environment)
PUPPET_CONTROL_REPO=./integrations/puppet

# SSH
SSH_CONFIG_PATH=./integrations/ssh/config
```
